...
OUTPUT = OUTPUT_DIR / "soul_studio_experience.json"
    ...
    return [
        {
            ...
            "facets": [
                ...
                },
                {
                    ...
                    "role": "explanation",
                    "kind": "textual",
                    "value": f"The persona explored Vita Soul Studio and saved a valid {output.name} artifact.",
                },
                {
...
def _build_decision_context(data: dict[str, object]) -> dict[str, object]:
    ...
    if "task_favorite_profile" in data:
        facets.append({
            "key": "favorite_profile",
            "label": "Favorite profile",
            "role": "evidence",
            "kind": "categorical",
            "value": str(data["task_favorite_profile"]).strip(),
        })
...
def main() -> int:
    ...
    print("PASS: Vita Soul Studio web evaluation artifacts are valid")
    return 0
