    ...
    return [
        {
            ...
            "facets": [
                ...
                },
                {
                    ...
                    "kind": "textual",
                    "value": (
                        f"The persona explored the vehicle dashboard via CocoaAgent and saved a valid {output.name} artifact."
                    ),
                },
                {
        ...
        },
        {
            ...
            "facets": [
                ...
                },
                {
                    ...
                    "kind": "textual",
                    "value": (
                        f"The submission artifact {output.name} matches the persona vehicle dashboard experience."
                    ),
                },
            ],
        },
